  ...
  return (
    <div aria-label="本地学习库设置" aria-modal="true" className="settings-dialog" role="dialog">
      <div className="settings-dialog__panel">
        ...
        {mutationState.delayedSwitch === null ? null : (
          <section
            aria-live="polite"
            ...
            <div className="settings-switch-recovery__actions">
              ...
              {mutationState.delayingMutation?.cancellable === true ? (
                <button
                  ...
                  onClick={() => {
                    const mutationId =
                      mutationState.delayingMutation?.id;
                    if (
                      mutationId === undefined ||
                      !cancelDelayingLibraryMutation(mutationId)
                    ) {
                      setError("这个保存已进入提交阶段，不能安全取消。");
                    }
                  }}
                  type="button"
                >
